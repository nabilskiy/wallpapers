...
fun isMonthContent(subscription: SubscriptionStatus?) =
        subscription != null &&
                subscription.isEntitlementActive && MONTH_SKU == subscription.sku && !subscription.subAlreadyOwned

fun isSixContent(subscription: SubscriptionStatus?) =
        subscription != null &&
                subscription.isEntitlementActive && MONTH_SKU == subscription.sku && !subscription.subAlreadyOwned

fun isYearContent(subscription: SubscriptionStatus?) =
        subscription != null &&
                subscription.isEntitlementActive && MONTH_SKU == subscription.sku && !subscription.subAlreadyOwned
