...
import wallgram.hd.wallpapers.util.downloadx.Progress
import wallgram.hd.wallpapers.util.downloadx.State
import wallgram.hd.wallpapers.util.downloadx.helper.Default
import wallgram.hd.wallpapers.util.downloadx.utils.clear
import wallgram.hd.wallpapers.util.downloadx.utils.closeQuietly
import wallgram.hd.wallpapers.util.downloadx.utils.fileName
import wallgram.hd.wallpapers.util.downloadx.utils.log
import java.io.File
        ...
        return downloadProgressFlow.flatMapConcat {
            ...
            channelFlow {
                while (currentCoroutineContext().isActive) {
                    ...
                    if (hasSend && stateHolder.isEnd() || getState() !is State.Downloading) {
                        if (!ensureLast) {
                            break
                        }
                    }
