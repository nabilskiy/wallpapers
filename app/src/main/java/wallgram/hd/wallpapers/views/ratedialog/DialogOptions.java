...
final class DialogOptions {
    ...
    private int titleResId = R.string.rate_title;

    private int messageResId = R.string.rate_dialog_message;

    private int textPositiveResId = R.string.ok_btn;

    private int textNeutralResId = R.string.rate_neutral;

    private int textNegativeResId = R.string.rate_later;
